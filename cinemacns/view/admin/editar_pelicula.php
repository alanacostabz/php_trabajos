              ...
              <form action="editar.php?id=<?php echo $id; ?>" method="post" class="needs-validation" novalidate>
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="imagen" class="form-control" placeholder="Insertar URL de la imágen" value="<?php echo $movie['IMAGEN']; ?>" required>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="trailer" placeholder="Insertar URL del trailer" value="<?php echo $movie['TRAILER']; ?>" required>
                    <div class="invalid-feedback">
                      Este campo no debe estar vacío.
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="direccion" class="form-control" placeholder="Ingresar director/es" value="<?php echo $movie['DIRECTOR']; ?>" required>
                    <div class="invalid-feedback">
                      Este campo no debe estar vacío.
                    </div>
                  </div>
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="reparto" placeholder="Ingresar reparto" value="<?php echo $movie['REPARTO']; ?>" required>
                    <div class="invalid-feedback">
                      Este campo no debe estar vacío.
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-4 mb-3">
                    ...
                    <input class="form-control" type="number" min="0" value="<?php echo $movie['DURACION']; ?>" max="300" name="duracion" required>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-md-4 mb-3">
                    ...
                    <input class="form-control" type="date" value="<?php echo $movie['FECHA_ESTRENO']; ?>" name="fechaEstreno" required>
                    <div class="invalid-feedback">
                      Debe completar este campo.
                    </div>
                  </div>
                  ...
                  <div class="col-md-4 mb-3">
                    ...
                    <select class="custom-select d-block w-100" name="clasificacion" required>
                      ...
                      if ($clasificacion == 'B15') {
                        echo '<option selected>B15</option>';
                      } else {
                  ...
                  <div class="col-md-4 mb-3">
                    ...
                    <select class="custom-select d-block w-100" name="productora" required>
                      ...
                      while ($productora = mysqli_fetch_assoc($productoras_set)) {
                        ...
                        if ($productora['NOMBRE'] == $movie['PRODUCTORA']) {
                          echo "<option selected>" . $productora['NOMBRE'] . "</option>";
                        } else {
                  ...
                  <div class="col-md-4 mb-3">
                    ...
                    <select class="custom-select d-block w-100" name="genero" required>
                      ...
                      while ($genero = mysqli_fetch_assoc($generos_set)) {
                        ...
                        if ($genero['ID'] == $movie['GENERO']) {
                          echo "<option selected>" . $genero['NOMBRE'] . "</option>";
                        } else {
                ...
                <div class="row">
                  <div class="form-group col-md-12 mb-3">
                    <textarea class="form-control" name="sipnosis" rows="3" placeholder="Escribir sipnosis..." required><?php echo $movie['SIPNOSIS']; ?></textarea>
                    <div class="invalid-feedback">
                      Debe completar este campo.
                    </div>
                  </div>
