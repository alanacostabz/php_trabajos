...
if (!isset($nombre) || $nombre == '') {
  ...
  $productora_set = searchProductora($nombre);

  if (empty($productora_set)) {
    echo '<script type="text/javascript">
  ...
  <div class="container-fluid">
    ...
    <button class="btn btn-sm btn-outline-secondary dropdown-toggle">
      ...
      This week
        ...
        <form action="guardar_productora.php" method="POST">
          <div class="input-group mb-3">
            <input type="text" class="form-control form-control-sm" name="campo_productora" placeholder="Agregar Productora">
        ...
        <form action="buscar_productora.php" method="POST">
          <div class="input-group mb-3">
            <input type="text" class="form-control form-control-sm" name="buscar" placeholder="Buscar Productora">
            <div class="input-group-append">
        ...
        <div class="table-responsive">
          <table class="table table-striped table-sm">
            ...
            <tbody>
              ...
              while ($productora = mysqli_fetch_assoc($productora_set))
                if (empty($productora)) {
                  echo '<h3>No hay Productoras agreadas aun aún</h3>';
                } else {

                  echo "<tr>";
                  echo "<td>" . $productora['NOMBRE'] . "</td>";
                  echo  "<td style='color:#fff'; width=5%><a class='btn btn-sm btn-warning' role='button' href='editar_productora.php?id=" . $productora['ID'] . "'>Editar</a></td>";
                  echo  "<td style='color:#fff'; width=5%><a class='btn btn-sm btn-danger' role='button' href='eliminar_productora.php?id=" . $productora['ID'] . "'>Borrar</a></td>";
                  echo "</tr>";
                }
