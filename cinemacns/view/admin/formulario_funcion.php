    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        ...
        <div class="container">
          ...
          <form action="nueva_funcion.php" method="post" class="needs-validation" novalidate>
            ...
            <div class="row">
              ...
              <div class="col-md-4 mb-3">
                ...
                <input class="form-control" type="date" value="<?php echo date('Y-m-d'); ?>" name="fechaFuncion" required>
                <div class="invalid-feedback">
                  Debe completar este campo.
                </div>
              </div>
              ...
              <div class="col-md-4 mb-3">
                ...
                <input class="form-control" type="time" value="<?php echo date('H:i', time()); ?>" name="horaFuncion" required>
                <div class="invalid-feedback">
                  Debe completar este campo.
                </div>
              </div>
