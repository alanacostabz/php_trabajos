...
$generos = mysqli_fetch_assoc($generos_set)
?>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-sm">
            ...
            <tbody>
              ...
              while ($generos = mysqli_fetch_assoc($generos_set))
                if (empty($generos)) {
                  echo '<h3>No hay Generos agreados aun aún</h3>';
                } else {

                  echo "<tr>";
                  echo "<td>" . $generos['NOMBRE'] . "</td>";
                  echo  "<td style='color:#fff'; width=5%><a class='btn btn-sm btn-warning' role='button' href='editar_genero.php?id=" . $generos['ID'] . "'>Editar</a></td>";
                  echo  "<td style='color:#fff'; width=5%><a class='btn btn-sm btn-danger' role='button' href='eliminar_generos.php?id=" . $generos['ID'] . "'>Borrar</a></td>";
                  echo "</tr>";
                }
