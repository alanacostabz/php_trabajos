          ...
          <table class="table table-striped table-sm">
            ...
            <tbody>
              ...
              while ($productora = mysqli_fetch_assoc($productoras_set)) {
                if (empty($productora)) {
                  echo '<h3>No hay productoras agreados aun aún</h3>';
                } else {

                  echo "<tr><form action='editar_pro.php' method='POST'><td>
                  <input type='hidden' name='id' value='" . $productora['ID'] . "'>
                  <input type='text' class='form-control' name='campo_productora' value='" . $productora['NOMBRE'] . "'>
                  </td>";
