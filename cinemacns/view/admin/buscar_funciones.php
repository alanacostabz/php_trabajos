...
$funciones_set = searchFunctionByMovieName($nombre);
?>
            ...
            <tbody>
              ...
              while ($funcion  = mysqli_fetch_assoc($funciones_set)) {
                ...
                if (empty($funcion)) {
                  ...
                  echo  "<td style='color:#fff'; width=5%><a class='btn btn-sm btn-warning' role='button' href='editar_funcion.php?id=" . $funcion['ID'] . "'>Editar</a></td>";
                  echo  "<td style='color:#fff'; width=5%><a class='btn btn-sm btn-danger' role='button' href='eliminar_funciones.php?id=" . $funcion['ID'] . "'>Borrar</a></td>";
                  echo "</tr>";
                }
              }
              ?>
