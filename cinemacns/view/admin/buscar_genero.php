...
if (!isset($nombre) || $nombre == '') {
  ...
  $genero_set = searchGenero($nombre);
            ...
            <tbody>
              ...
              while ($genero = mysqli_fetch_assoc($genero_set))
                if (empty($genero)) {
                  ...
                  echo  "<td style='color:#fff'; width=5%><a class='btn btn-sm btn-warning' role='button' href='editar_genero.php?id=" . $genero['ID'] . "'>Editar</a></td>";
                  echo  "<td style='color:#fff'; width=5%><a class='btn btn-sm btn-danger' role='button' href='eliminar_generos.php?id=" . $genero['ID'] . "'>Borrar</a></td>";
                  echo "</tr>";
                }
