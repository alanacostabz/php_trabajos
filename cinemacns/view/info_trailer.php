            ...
            <div class="col-md-6">
              <div class="profile-head">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link" id="home-tab" data-toggle="tab" href="info.php?id=<?php echo $id; ?>" role="tab" aria-controls="home" aria-selected="true">Sipnosis</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" id="profile-tab" data-toggle="tab" href="info_trailer.php?id=<?php echo $id; ?>" role="tab" aria-controls="profile" aria-selected="false">Trailer</a>
                  </li>
                </ul>
              </div>
              <div class="embed-responsive embed-responsive-16by9">
                <iframe class="embed-responsive-item" src="<?php echo substr($movie['TRAILER'], 0, 24) . "embed/" . substr($movie['TRAILER'], 32, strlen($movie['TRAILER'])); ?>"></iframe>
              </div>
            </div>
