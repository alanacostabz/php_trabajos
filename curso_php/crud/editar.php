...
<body>
  ...
  if (!isset($_POST['bot_actualizar'])) {
    ...
    $apellido = $_POST['ape'];
    $direccion = $_POST['dir'];
    $query = 'UPDATE DATOS_USUARIOS SET NOMBRE=:miNom, APELLIDO=:miApe, DIRECCION=:miDir WHERE ID=:myID';
    $resultado = $base->prepare($query);
    $resultado->execute(array(":myID" => $id, ":miNom" => $nombre, ":miApe" => $apellido, ":miDir" => $direccion));
